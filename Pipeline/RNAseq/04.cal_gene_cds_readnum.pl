#calculate gene  reads number, based on the output of 01 or 02 
...
#7/2/2015 can output a file for all junction reads mapping to gene information ($if_out_juncread_detail)
...
###use parameter from command line
#eg: perl 04.cal_gene_cds_readnum.pl -s SkeMuscle  -g mm9 -i gene_id  -p mmMuscle2. -l 32 -e transcript 
#eg: perl 04.cal_gene_cds_readnum.pl -s C2C12_RNASeq  -g mm9 -i refseqid  -p refseq.comprehensive. -e comprehensive -a pro,diff
#eg: perl 04.cal_gene_cds_readnum.pl -s dsRBD_OE_3pS -g mm9 -i refseqid -p refseq.comprehensive. -e comprehensive -a Ctrl,p10A,p20 -d 1 -r 1 
#eg: perl 04.cal_gene_cds_readnum.pl -s Riboseq -g mm9 -i refseqid -p refseqcds. -e CDS -a C2C12P_S0,C2C12P_S1,C2C12P_S2  
#eg: perl 04.cal_gene_cds_readnum.pl -s C2C12_NRO  -g mm9 -i refseqid  -p refseq.comprehensive. -e comprehensive -a pro,diff
